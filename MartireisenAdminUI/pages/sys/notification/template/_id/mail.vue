    ...
    <a-row :gutter="15">
      <a-col :span="18">
        <a-card class="no-padding">
          ...
          <div class="pd-20">
            <a-form-item :label="$t('common.language')" :label-col="{ span: 3 }" :wrapper-col="{ span: 21 }"
              class="text-left">
            ...
            <a-form-item label="Konu" :label-col="{ span: 3 }" :wrapper-col="{ span: 21 }" class="text-left">
              <a-input v-model="mail.subject"></a-input>
            </a-form-item>

            <a-form-item label="Mesaj" :label-col="{ span: 3 }" :wrapper-col="{ span: 21 }" class="text-left">
              <editor id="editor" :api-key="e.api_key" :init="e.settings" v-model="mail.message">
              </editor>
            </a-form-item>
      ...
      <a-col :span="6">
        <a-card>
          ...
          <ul class="list-group list-group-flush">
            <li class="pt-2 pb-2 list-group-item" v-bind:key="item" v-for="(param, item) in parent.parameters">{{ param
              }}
            </li>
          </ul>
        </a-card>
