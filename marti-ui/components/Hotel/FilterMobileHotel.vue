            ...
            <div class="modal-body">
                ...
                <div class="sidebar mt-0">
                    ...
                    <div class="sidebar-category">
                        ...
                        v-bind:key="index"
                        >
                        <input type="checkbox" :id="'k' + index" v-model="filter.keywordList"  :value="item.code" v-on:change="set('keywordList')" />
                ...
                <!-- end sidebar -->
                <div class="col-lg-2" >
                    <button @click="do_filter" class="apply-filter-button theme-btn theme-btn-orange font-weight-bold d-lg-none d-block">{{ $t('search.filter_accept') }}</button>
                </div>
            </div>
