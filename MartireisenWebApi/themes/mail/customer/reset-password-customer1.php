      ...
      <div style="padding: 40px 40px 20px; background: rgb(255, 255, 255);">
         <table cellpadding="0" cellspacing="0" style="width: 100%; border: 0px;">
            <tbody>
               <tr>
                  <td>
                     <h3 style="margin-bottom: 20px; color: rgb(36, 34, 47); font-weight: 600;">{#mail_subject#}</h3>
                     <p>{#dear#} {{name}} {{surname}}</p>
                     <p>{#mail_info_text#}</p>

                     <p>{#regards#}</p>
                     <div style="text-align: center;"><a href="{{url}}/my/recovery-password/{{recovery_key}}" style="text-decoration:none;display: inline-block; padding: 6px 30px 6px; margin: 20px 0px 30px; font-size: 15px; color: rgb(255, 255, 255); background: rgb(1, 168, 254); border-radius: 5px;">{#reset_password#}</a></div>
                  </td>
               </tr>
            </tbody>
         </table>
