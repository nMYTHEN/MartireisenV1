            ...
            <tbody>
               <tr>
                  <td>
                        ...
                        <p>{#regards#}</p>
                        <div style="text-align: center;"><a href="{{url}}/" style="text-decoration:none;display: inline-block; padding: 6px 30px 6px; margin: 20px 0px 30px; font-size: 15px; color: rgb(255, 255, 255); background: rgb(1, 168, 254); border-radius: 5px;">{#go_employer_board#}</a></div>
                  </td>
               </tr>
            </tbody>
         </table>
