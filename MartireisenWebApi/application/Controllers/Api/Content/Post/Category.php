...
use Model\Content\Post\Category as Model;
use Model\Content\Post\CategoryTranslation;
...
class Category extends Webservice {
    ...
    public function __construct() {  
        ...
        $this->linkModel->setType('content/post-category');
    }
    ...
    public function store() {
        ...
        try {
            ...
            $categoryTranslation->description = $data->description;
    ...
    public function update($id = 0) {
        ...
        $link = new Link();
        $link->setType('content/post-category');
