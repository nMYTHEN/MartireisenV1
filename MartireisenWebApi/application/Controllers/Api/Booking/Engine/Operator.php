...
use Model\Booking\Operator as Model;

class Operator extends Webservice {
    ...
    public function store() {
        ...
        $record->is_booking_online      = isset($data->is_booking_online) ? (int)$data->is_booking_online : 1;
    ...
    public function update($id = 0) {
        ...
        $record->is_booking_online      = isset($data->is_booking_online) ? (int)$data->is_booking_online : $record->is_booking_online;
        $record->save();
